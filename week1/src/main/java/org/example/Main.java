...
public class Main {
    ...
    static void taskImporter(int taskNumber){
        switch (taskNumber) {
            ...
            case 5:
                ...
                break;
            case 6:
                Sixth.main(new String[]{});
                break;
            case 7:
                Seventh.main(new String[]{});
                break;

            case 8:
                Eighth.main(new String[]{});
                break;

            case 9:
                Ninth.main(new String[]{});
                break;
        }
    }
    ...
    public static void main(String[] args) {
        ...
        String[] finishedTasks = {"First Task", "Second Task", "Third Task", "Fourth Task", "Fifth Task", "Sixth Task", "Seventh Task", "Eighth Task","Ninth Task Task"};

        while (true){
            System.out.println("=============================");
            System.out.println("Welcome To Lab 1 Task Answers");
